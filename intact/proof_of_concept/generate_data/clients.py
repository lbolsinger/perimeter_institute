...
def generate_clients():
    ...
    for client in clients:
        client[10] = comp.retention_prob(client, average_age, std_dev_age, average_accidents, std_dev_accidents, 
                                        average_income, std_dev_income, average_premium, std_dev_premium)
